        ...
        if 'agenda_items' in normalized_record:
            ...
            for item in normalized_record['agenda_items']:
                ...
                if 'speech_text' in normalized_item:
                    normalized_item['speech_text'] = self.normalize_text(normalized_item['speech_text'])
                if 'agenda_item' in normalized_item:
                    normalized_item['agenda_item'] = self.normalize_text(normalized_item['agenda_item'])
                if 'speaker' in normalized_item:
                    normalized_item['speaker'] = self.normalize_text(normalized_item['speaker'])
                
                # 段落抽出
                if 'speech_text' in normalized_item:
                    normalized_item['paragraphs'] = self.extract_paragraphs(normalized_item['speech_text'])
